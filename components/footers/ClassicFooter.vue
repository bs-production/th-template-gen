<template>
   <!-- Site Footer -->
	...
	<ul>
		<li><a href="http://devtest151.basementsite.com/roof-repair.html">Roof Repair</a></li><li><a href="http://devtest151.basementsite.com/roof-replacement.html">Roof Replacement</a></li>
	</ul>
</li><li class="footer-link about">Our Company
	<ul>
		<li><a href="http://devtest151.basementsite.com/about-us.html">About Us</a></li><li><a href="http://devtest151.basementsite.com/about-us/privacy-statement.html">Privacy Policy</a></li><li><a href=""></a></li><li><a href="http://devtest151.basementsite.com/sitemap.html">Sitemap</a></li>
	</ul>
</li>
</ul>                                		<style>
			.social-footer a {
			...
			#footer-links #social-footer-icons a,
			#social-footer-icons a {
				display: inline-block;
				margin: 2px;
			}
			#footer-links #social-footer-icons > a > svg,
		...
		<div id="social-footer-icons">
                        ...
                        <div class="large-5 cell large-order-1">
                            <div id="footer-contact">
                                ...
                                <p>Or call us at
                                    <a href="tel:1-222-222-2222" class="phone_link">1-222-222-2222</a>
                                </p>
                                <p>
                                    &copy; 2020 </p>
...
#footer a.button {
    ...
    border-radius:5px;
    max-width:300px;
    font:bold 24px/1.25 sans-serif;
    margin:0 auto 20px;
